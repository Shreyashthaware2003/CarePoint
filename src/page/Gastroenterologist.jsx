                    ...
                    <div className=''>
                        ...
                        <div className='flex flex-col md:flex-row gap-4 my-4'>
                            ...
                            <div className={`${isVisible ? 'flex' : 'hidden'} md:flex flex-col  space-y-4 text-sm text-gray-500 font-medium tracking-wide md:tracking-normal`}>
                                ...
                                <Link to={'/doctors'} className={`${isVisible ? 'bg-[#E2E5FF] text-black' : 'bg-[#E2E5FF] text-black'}  pl-3 pr-16 py-2 rounded-md border border-gray-300 `}>Gastroenterologist</Link>
                            </div>
